...
if __name__ == '__main__':
    out_path_min = "/content/drive/MyDrive/kaist_output/ssd-h_crowded_change_kernel"
    fps = 3
    frame_array = []
    ...
    with open(os.path.join('/content/drive/MyDrive/kaist_output', 'ssd-h_crowded_change_kernel.json'), 'w') as j:
